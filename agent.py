...
class Agent():
    def __init__(self, model, actions):
        ...
        self.random_action_decay_factor    = 0.99  # factor which controls how much we decay the random action fallover factor over time.
        self.random_action_factor_floor    = 0.01  # the minimum value to which the random_action_fallback_factor can decay to.
        #
        self.historical_space = deque(maxlen=2000)
